...
export default function CoursesCard({ title, icon, desc }) {
  return (
      ...
      <div className="hover-lift relative flex flex-col justify-between p-8 rounded-lg bg-surface-dark border border-white/5 hover:border-primary/30 transition-all duration-300 h-full min-h-[320px]">
        ...
        <div className="pt-8 mt-auto">
           ...
           <span className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-white group-hover:text-primary transition-colors">
            View Details
