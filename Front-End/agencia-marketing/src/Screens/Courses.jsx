const courses = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1551288049-bbda4865cda1?auto=format&fit=crop&q=80&w=400"
  },
  {
    id: 4,
    ...
    <div className="min-h-screen bg-background-dark font-body text-white p-8 pb-20">
      ...
      <header className="max-w-7xl mx-auto mb-16 pt-12 animate-fade-in-up">
        ...
        <h1 className="font-display text-5xl md:text-7xl font-bold mb-8 leading-tight tracking-tight">
          Eleva tu <span className="text-primary italic">Maestría</span> Profesional
        </h1>
        
        <div className="max-w-3xl border-l border-primary-dark/50 pl-8">
          <p className="text-slate-400 text-lg md:text-xl leading-relaxed">
            Explora una selección rigurosa de programas diseñados para líderes tecnológicos. 
            Domina las competencias más críticas del mercado con una metodología de 
            aprendizaje profundo y visión empresarial.
          </p>
        </div>
      </header>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        {courses.map((course) => (
          <div
            key={course.id}
            className="group bg-surface-dark border border-white/5 rounded-2xl overflow-hidden hover:shadow-glow transition-all duration-500 hover:-translate-y-3"
          >
            ...
            <div className="relative h-56 overflow-hidden">
              ...
              />
              <div className="absolute top-4 left-4 bg-background-dark/40 backdrop-blur-md border border-white/10 text-primary-soft text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-widest">
                {course.category}
              </div>
            </div>
